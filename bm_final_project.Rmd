...
model_caret<-train(target_death_rate ~ incidence_rate + binned_inc + percent_married + pct_hs18_24 + pct_bach_deg18_24 + pct_hs25_over + pct_white + pct_other_race + median_age_female,
                   data = cancer_mod,
                   trControl=data_train,
                   method='lm',
                   na.action=na.pass)

model_caret<-train(target_death_rate ~ incidence_rate + binned_inc + percent_married + pct_hs25_over + pct_white,
                   data = cancer_mod,
                   trControl=data_train,
                   method='lm',
                   na.action=na.pass)
